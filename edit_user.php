...
<div class="container">
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label>Image:</label>
      <input type="file" class="form-control" value="<?php echo $user_details;?>" placeholder="Name" name="image">
    </div>
  ...
  $etmp_name=FILES['user_image'] ['tmp_name']
  ...
  $update="UPDATE user SET user_name='$user_email',user_password='$user_password',user_image='$user_image',user_details='$user_details' WHERE user_id='edit_id' ";

  $run_update=mysqli_query($conn,$update);
  if($run_update===true) {
    echo "Data Has Been Updated";
    move_uploaded_file($eimaeg_tmp,"upload/$eimage");
  }else{
